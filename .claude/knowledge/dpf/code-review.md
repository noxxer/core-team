...
- **Связи:** дополняет [P-03] (CHK-WIRE) и [P-04] (CHK-ORPHAN) — они говорят, ЧТО проверять, P-13 говорит, как принять саму проверку; смыкается с [P-11] (Code-Change Discipline: evidence перед правкой); в `dpf/development.md` соседствует с P-11 (mutation score как метрика сьюта — другой предмет).
