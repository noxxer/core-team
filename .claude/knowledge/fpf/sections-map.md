...
| # | 91 | A.6.B | Boundary Norm Square | boundary norm square, laws, admissibility, deontics, evidence | Квадрат норм границ для декомпозиции предложений. |
...
| # | 94 | A.6.1 | U.Mechanism | mechanism, operation algebra, law set, admissibility, transport | Механизм как управляемое применение к субъектам. |
| # | 95 | A.6.2 | U.EffectFreeEpistemicMorphing | epistemic morphing, morphism, lenses, reproducibility | Безэффектные морфизмы эпистем для трансформаций. |
| # | 96 | A.6.3 | U.EpistemicViewing | epistemic viewing, view, viewpoint, representation, correspondence | Сохранение описываемой сущности в просмотрах. |
| # | 97 | A.6.4 | U.EpistemicRetargeting | retargeting, kind bridge, structural reinterpretation | Перенаправление описываемой сущности через мосты. |
| # | 98 | A.6.P | U.RelationalPrecisionRestorationSuite | precision restoration, relation kind, qualified relation, lexical | Восстановление точности отношений через квалификацию. |
| # | 99 | A.6.Q | U.QualityTermPrecisionRestoration | quality term, evaluative ascription, endpoint routing, bridge | Восстановление точности качественных терминов. |
| # | 100 | A.6.A | U.ActionInvitationPrecisionRestoration | affordance, action invitation, post-threshold routing, docking | Восстановление точности приглашений к действию. |
| # | 101 | A.6.5 | U.RelationSlotDiscipline | slot discipline, value, reference, signature, substitution | Дисциплина слотов для n-арных отношений. |
| # | 102 | A.6.6 | U.BaseDeclarationDiscipline | base declaration, basedness, witnesses, anchoring, rebase | Дисциплина деклараций баз с явными свидетелями. |
| # | 103 | A.6.7 | MechSuiteDescription | mechanism suite, obligations, contract pins, CN-Spec, CG-Spec | Описание набора механизмов с обязательствами. |
...
| # | 105 | A.6.9 | U.CrossContextSamenessDisambiguation | cross-context, sameness, bridge, alignment, substitution | Разрешение самотождественности через мосты. |
| # | 106 | A.6.S | U.SignatureEngineeringPair | signature engineering, target, constructor, editioning, retargeting | Пара сигнатур для конструктивной инженерии. |
...
| # | 121 | A.15.3 | SlotFillingsPlanItem | slot fillings, baseline, edition pins, variance trail | Планируемый baseline для заполнения слотов. |
| # | 122 | A.16 | Language-State Move Coordination | language-state, move, reopen, respecify, handoff | Координация ходов языка-состояния. |
| # | 123 | A.16.0 | U.LanguageStateMoveTrajectory | trajectory, lineage, fork, merge, supersedes | Траектория ходов как учет lineage. |
...
| # | 126 | A.17 | A.CHR-NORM | characteristic, measurement, property, dimension, axis | Канонический термин для измеримого свойства. |
| # | 127 | A.18 | A.CSLC-KERNEL | CSLC, scale, level, coordinate, measurement | Минимальный CSLC в ядре для измерений. |
| # | 128 | A.19 | A.CHR-SPACE | characteristic space, state space, dynamics, RSG | Пространство характеристик с хуком динамики. |
...
| # | 130 | A.19.CHR | CHRMechanismSuite | CHR suite, characterization, CN-Spec, CG-Spec, legality | Анкер свиты механизмов CHR. |
...
| # | 138 | A.21 | GateProfilization | gate profilization, operational gate, gate fit, decision log | Профилизация гейтов для фита. |
...
| # | 159 | B.1 | Universal Algebra of Aggregation | aggregation, Gamma, invariants, IDEM, COMM, WLNK | Универсальная алгебра агрегации через Gamma. |
| # | 160 | B.1.1 | Dependency Graph & Proofs | dependency graph, proofs, structural aggregators, sum | Граф зависимостей и доказательства для Gamma. |
| # | 161 | B.1.2 | System-specific Aggregation | system aggregation, physical, conservation, Sys-CAL | Агрегация физических систем с законами сохранения. |
| # | 162 | B.1.3 | Knowledge-Specific Aggregation | knowledge aggregation, epistemic, trust, KD-CAL | Агрегация знаний с propagацией доверия. |
| # | 163 | B.1.4 | Contextual & Temporal Aggregation | temporal aggregation, time-series, order-sensitive | Агрегация с учетом контекста и времени. |
| # | 164 | B.1.5 | Order-Sensitive Method Composition | method composition, workflow, sequential, concurrent | Композиция методов с учетом порядка. |
| # | 165 | B.1.6 | Work as Spent Resource | work aggregation, resource, cost, Resrc-CAL | Агрегация работы как потребленных ресурсов. |
| # | 166 | B.2 | Meta-Holon Transition (MHT) | meta-holon, emergence, synergy, system of systems | Транзиция для распознавания эмерджентности. |
...
| # | 172 | B.3 | Trust & Assurance Calculus (F-G-R) | trust, assurance, F-G-R, formality, reliability | Калькулюс доверия и assurance через F-G-R. |
...
| # | 197 | C.2.1 | U.Episteme | episteme, slot graph, described entity, grounding holon | Эпистемы как граф слотов с grounding. |
...
| # | 199 | C.2.2a | U.LanguageStateSpace | language-state space, position claim, thresholds, publication | Пространство языка-состояния над характеристиками. |
...
| ## | 232 | K.2 | Migration debt from A.2.6 | migration debt, deprecations, affected locations, playbook | Долг миграции от A.2.6 с заменами. |
...
| ## | 240 | K.2.2 | Affected locations and required edits | affected locations, edits, Part C.2.2, Part A.2.2 | Требуемые правки в затронутых частях. |
